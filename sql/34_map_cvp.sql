-- Values of MAP-CVP from 30 minutes before to 120 minutes after initiation of a vasoactive drug.
...
with
  ...
  , gain_map_cvp as (
    ...
    inner join create_map_cvp using (icu_stay_id)
