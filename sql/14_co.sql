-- Values of CO from 30 minutes before to 120 minutes after initiation of a vasoactive drug.
...
with
  ...
  -- Obtain CO from advanced_hemodynamic_monitoring
  , gain_co as (
    select
      icu_stay_id,
      active_ingredient_name,
