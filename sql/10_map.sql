-- Values of MAP from 30 minutes before to 120 minutes after initiation of a vasoactive drug.
...
with
  ...
  -- Obtain MAP from vital_measurements
  , gain_map as (
    select
      icu_stay_id,
      active_ingredient_name,
    ...
    inner join `medicu-beta.latest_one_icu.vital_measurements` using (icu_stay_id)
